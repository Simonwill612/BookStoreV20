...
{
    /// <inheritdoc />
    public partial class initBooksTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreOwner", x => x.StoreOwnerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorName = table.Column<int>(type: "int", nullable: true),
                    PublisherName = table.Column<int>(type: "int", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StoreOwnerId = table.Column<int>(type: "int", nullable: true),
                    AuthorNameNavigationAuthorId = table.Column<int>(type: "int", nullable: true),
                    PublisherNameNavigationPublisherId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AuthorNameNavigationAuthorId,
                        principalTable: "Author",
                        principalColumn: "AuthorId");
                    table.ForeignKey(
                        name: "FK_Book_Publisher_PublisherNameNavigationPublisherId",
                        column: x => x.PublisherNameNavigationPublisherId,
                        principalTable: "Publisher",
                        principalColumn: "PublisherId");
                    table.ForeignKey(
                        name: "FK_Book_StoreOwner_StoreOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CustomerId");
                    table.ForeignKey(
                        name: "FK_Order_StoreOwner_StoreOwnerId",
                        column: x => x.StoreOwnerId,
                        principalTable: "StoreOwner",
                        principalColumn: "StoreOwnerId");
                });
